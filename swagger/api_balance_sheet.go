...
/*
BalanceSheetApiService Retrieve the properties and relationships of an object of type balanceSheet for Dynamics 365 Business Central.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
 * @param balanceSheetLineNumber lineNumber for balanceSheet
 * @param optional nil or *BalanceSheetApiGetBalanceSheetOpts - Optional Parameters:
     * @param "Select_" (optional.Interface of []string) -  Selected properties to be retrieved
@return BalanceSheet
*/

type BalanceSheetApiGetBalanceSheetOpts struct { 
	Select_ optional.Interface
}

func (a *BalanceSheetApiService) GetBalanceSheet(ctx context.Context, companyId string, balanceSheetLineNumber int32, localVarOptionals *BalanceSheetApiGetBalanceSheetOpts) (BalanceSheet, *http.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"balanceSheet_lineNumber"+"}", fmt.Sprintf("%v", balanceSheetLineNumber), -1)
...
/*
BalanceSheetApiService Returns a list of balanceSheet
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
 * @param optional nil or *BalanceSheetApiListBalanceSheetOpts - Optional Parameters:
