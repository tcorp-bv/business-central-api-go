...
/*
AccountApiService Retrieve the properties and relationships of an object of type account for Dynamics 365 Business Central.
...
func (a *AccountApiService) GetAccount(ctx context.Context, companyId string, accountId string, localVarOptionals *AccountApiGetAccountOpts) (Account, *http.Response, error) {
	var (
...
/*
AccountApiService Returns a list of accounts
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
 * @param optional nil or *AccountApiListAccountsOpts - Optional Parameters:
