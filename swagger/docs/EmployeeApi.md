...
# **DeleteEmployee**
> DeleteEmployee(ctx, companyId, employeeId)
...
# **GetEmployee**
> Employee GetEmployee(ctx, companyId, employeeId, optional)
 ...
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **companyId** | [**string**](.md)| id for company | 
  **employeeId** | [**string**](.md)| id for employee | 
 **optional** | ***EmployeeApiGetEmployeeOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a EmployeeApiGetEmployeeOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 ...
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **companyId** | [**string**](.md)| id for company | 
 **optional** | ***EmployeeApiListEmployeesOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a EmployeeApiListEmployeesOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
# **PatchEmployee**
> Employee PatchEmployee(ctx, body, companyId, employeeId, contentType, ifMatch)
...
# **PostEmployee**
> Employee PostEmployee(ctx, body, companyId, contentType)
