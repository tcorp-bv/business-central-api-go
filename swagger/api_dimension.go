...
/*
DimensionApiService Retrieve the properties and relationships of an object of type dimension for Dynamics 365 Business Central.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
 * @param dimensionId id for dimension
 * @param optional nil or *DimensionApiGetDimensionOpts - Optional Parameters:
...
type DimensionApiGetDimensionOpts struct { 
	Expand optional.Interface
	Select_ optional.Interface
}

func (a *DimensionApiService) GetDimension(ctx context.Context, companyId string, dimensionId string, localVarOptionals *DimensionApiGetDimensionOpts) (Dimension, *http.Response, error) {
	var (
...
/*
DimensionApiService Returns a list of dimensions
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
 * @param optional nil or *DimensionApiListDimensionsOpts - Optional Parameters:
