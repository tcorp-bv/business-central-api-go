...
/*
TrialBalanceApiService Retrieve the properties and relationships of an object of type trialBalance for Dynamics 365 Business Central.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
 * @param trialBalanceNumber number for trialBalance
 * @param optional nil or *TrialBalanceApiGetTrialBalanceOpts - Optional Parameters:
...
type TrialBalanceApiGetTrialBalanceOpts struct { 
	Expand optional.Interface
	Select_ optional.Interface
}

func (a *TrialBalanceApiService) GetTrialBalance(ctx context.Context, companyId string, trialBalanceNumber string, localVarOptionals *TrialBalanceApiGetTrialBalanceOpts) (TrialBalance, *http.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"trialBalance_number"+"}", fmt.Sprintf("%v", trialBalanceNumber), -1)
...
/*
TrialBalanceApiService Returns a list of trialBalance
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
 * @param optional nil or *TrialBalanceApiListTrialBalanceOpts - Optional Parameters:
