...
// GetAccountOpts Optional parameters for the method 'GetAccount'
type GetAccountOpts struct {
	Select_ optional.Interface
}

/*
GetAccount Retrieve the properties and relationships of an object of type account for Dynamics 365 Business Central.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
 * @param accountId id for account
 * @param optional nil or *GetAccountOpts - Optional Parameters:
 * @param "Select_" (optional.Interface of []string) -  Selected properties to be retrieved
@return Account
*/
func (a *AccountApiService) GetAccount(ctx _context.Context, companyId string, accountId string, localVarOptionals *GetAccountOpts) (Account, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/companies({company_id})/accounts({account_id})"
...
*/
func (a *AccountApiService) ListAccounts(ctx _context.Context, companyId string, localVarOptionals *ListAccountsOpts) (InlineResponse20013, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/companies({company_id})/accounts"
	localVarPath = strings.Replace(localVarPath, "{"+"company_id"+"}", _neturl.QueryEscape(parameterToString(companyId, "")), -1)
