...
/*
DeleteCustomer Deletes an object of type customer in Dynamics 365 Business Central
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
 * @param customerId id for customer
*/
func (a *CustomerApiService) DeleteCustomer(ctx _context.Context, companyId string, customerId string) (*_nethttp.Response, error) {
	var (
...
/*
GetCustomer Retrieve the properties and relationships of an object of type customer for Dynamics 365 Business Central.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
 * @param customerId id for customer
...
@return Customer
*/
func (a *CustomerApiService) GetCustomer(ctx _context.Context, companyId string, customerId string, localVarOptionals *GetCustomerOpts) (Customer, *_nethttp.Response, error) {
	var (
...
// ListCustomersOpts Optional parameters for the method 'ListCustomers'
type ListCustomersOpts struct {
	Top     optional.Int32
	Skip    optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
 * @param optional nil or *ListCustomersOpts - Optional Parameters:
...
*/
func (a *CustomerApiService) ListCustomers(ctx _context.Context, companyId string, localVarOptionals *ListCustomersOpts) (InlineResponse2004, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
PatchCustomer Updates an object of type customer in Dynamics 365 Business Central
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
 * @param customerId id for customer
...
@return Customer
*/
func (a *CustomerApiService) PatchCustomer(ctx _context.Context, companyId string, customerId string, contentType string, ifMatch string, uNKNOWNBASETYPE UNKNOWN_BASE_TYPE) (Customer, *_nethttp.Response, error) {
	var (
...
/*
PostCustomer Creates an object of type customer in Dynamics 365 Business Central
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
 * @param contentType application/json
 * @param uNKNOWNBASETYPE
@return Customer
*/
func (a *CustomerApiService) PostCustomer(ctx _context.Context, companyId string, contentType string, uNKNOWNBASETYPE UNKNOWN_BASE_TYPE) (Customer, *_nethttp.Response, error) {
	var (
